...
public class Users{
	...
	public void EditProfile() {
		...
		try (Scanner scanner = new Scanner(System.in)) {
			...
			switch(editinput) {
				...
				case 3:
					System.out.println("Digite seu novo pa�s:\n");
					country = scanner.nextLine();
					System.out.println("OK!");
					break;
	...
	public void AddComunidade(ArrayList<Users> u) {
		...
		try (Scanner scanner = new Scanner(System.in)) {
			...
			if(mycommunity != null) {
				...
				System.out.println("\nDigite o username do membro que voc� deseja adicionar � comunidade:");
	...
	public void SendMessage(ArrayList<Users> u) {
		...
		try (Scanner scanner = new Scanner(System.in)) {
			...
			System.out.println("\nDigite o username do membro que voc� deseja enviar uma mensagem:");
	...
	public void PeekMessages() {
		...
		try (Scanner scanner = new Scanner(System.in)) {
			...
			System.out.println("\nDigite o username do membro que voc� deseja ler a mensagem:");
