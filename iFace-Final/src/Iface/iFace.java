			...
			try {
				...
				switch(input) {
					...
					case 2:
						...
						if(flag0 == 0) {
							System.out.println("Erro: login ou senha invalido!\nTente novamente!");
							break;
						}
								...
								try {
									...
									case 2:
												...
												if(accept == 1) {
													...
													for(j = 0; j < users.size(); j++) {
														...
														if(users.get(id).newfriends.get(i).equals(users.get(j).nickname)) {
															...
															System.out.println("\nVoce aceitou o pedido de " + users.get(id).newfriends.get(i) + "!");
														}
													}
										...
										case 6:
											...
											System.out.println("\nDigite o nome da comunidade que voce deseja encontrar:");
									...
									System.out.println("\nEscolha uma opcao:\n1 - Editar meu perfil\n2 - Adicionar um novo amigo\n3 - Aceitar nova solicitacao de amizade\n4 - Visualizar seu perfil\n5 - Visualizar o perfil de um membro\n6 - Visualizar uma comunidade\n7 - Enviar uma mensagem\n8 - Ler suas mensagens\n9 - Criar uma comunidade\n10 - Adicionar um membro � sua comunidade\n11 - Apagar sua conta\n12 - Sair\n");
								 }
